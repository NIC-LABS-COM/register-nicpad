sap.ui.define([
    ...
    "sap/m/MessageToast",
], function (Controller, UIComponent, mobileLibrary, JSONModel, MessageItem, MessageView, Button, Bar, Dialog, IconPool, Text, Filter,
    FilterOperator, History, MessageToast) {
    "use strict";
    ...
    return Controller.extend("sap.ui.demo.todo.controller.BaseController", {
        ...
        setUserTheme: function (bInit) {
            ...
            if (currentTheme === "") {
                currentTheme = "sap_horizon"; //Default 
            }
            if (!bInit) {
                if (currentTheme === "sap_horizon") {
                    newTheme = "sap_horizon_dark";
                } else {
                    newTheme = "sap_horizon"
                }
        ...
        _setTheme: function (bInit, userId, newTheme) {
            var dialogBusy = new sap.m.BusyDialog(),
                busyText = this.getResourceBundle().getText("busyTextChangeTheme");
